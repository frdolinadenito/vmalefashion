                                 ...
                                 <div class="info-product-price">
                                    <div class="grid_meta">
                                       <div class="product_price">
                                          <h4>
                                             <a href="{{route('single')}}">toys(barbie)</a>
                                          </h4>
                              ...
                              <div class="item-info-product">
                                 <div class="info-product-price">
                                    <div class="grid_meta">
                                       <div class="product_price">
                                          <h4>
                                             <a href="{{route('single')}}">toy(todos)</a>
                                          </h4>
                                          <div class="grid-price mt-2">
                              ...
                              <div class="item-info-product">
                                 <div class="info-product-price">
                                    <div class="grid_meta">
                                       <div class="product_price">
                                          <h4>
                                             <a href="{{route('single')}}">toys (Grey)</a>
                                          </h4>
                                          <div class="grid-price mt-2">
                              ...
                              <div class="item-info-product">
                                 <div class="info-product-price">
                                    <div class="grid_meta">
                                       <div class="product_price">
                                          <h4>
                                             <a href="{{route('single')}}">toys (red)</a>
                                          </h4>
                                          <div class="grid-price mt-2">
                              ...
                              <div class="item-info-product">
                                 <div class="info-product-price">
                                    <div class="grid_meta">
                                       <div class="product_price">
                                          <h4>
                                             <a href="{{route('single')}}">toys(blue)</a>
                                          </h4>
                                          <div class="grid-price mt-2">
                              ...
                              <div class="item-info-product">
                                 <div class="info-product-price">
                                    <div class="grid_meta">
                                       <div class="product_price">
                                          <h4>
                                             <a href="{{route('single')}}">toys(pink)</a>
                                          </h4>
                                          <div class="grid-price mt-2">
