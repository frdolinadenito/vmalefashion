...
<div class="content-wrapper">
    <div class="">
	  ...
	  @foreach($pengguna as $user)
			...
			<div class="col-md-4">
				<h3>Pengiriman</h3>
				<strong>{{ $user->Alamat_Lengkap }}</strong><br>
				@foreach($ongkir as $ongkirs)@endforeach Ongkos Kirim: Rp <?php echo number_format($ongkirs->Tarif); ?>,00<br>
				Jasa Pengiriman: {{ $user->Jasa_Pengiriman }}
