            ...
            <div class="table-responsive">
                ...
                @php $no = 1; @endphp
                    ...
                    <tr>
                        ...
                        <td>
								<a href="{{ route('kategori.kembalikan', $value['id']) }}" class="btn btn-success btn-sm">Restore</a>
								<a href="{{ route('kategori.hapus_permanen', $value['id']) }}" class="btn btn-danger btn-sm">Hapus Permanen</a>
							</td>
                        <!-- <td>
