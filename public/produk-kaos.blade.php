      ...
      <div class="row">
         ...
         <div class="right" style="background-color:#f0f0f0;">
            ...
            <div class="row">
               ...
               <?php if ($product["ID_Kategori"] == 1) { ?>
                <?php if ($product["Stok"] != 0) { ?>
                  <div class="col-md-4">
                     <!-- small box -->
                     <div class="small-box bg-green">

                        <img src="uploadImage/{{ $product['gambar'] }}" width=100% height=60% />

                        <h1>{{ $product['Nama_Barang']}}</h1>
                        <p>RP <?php echo number_format($product['Harga_Barang']); ?>,00</p>
                        <td>
                           <a href="{{ route('cart', $product['id']) }}" class="btn btn-warning " role="button">Tambah ke Keranjang</a>

                        </td>

                        <td>
                           <a href="{{ route('favorit', $product['id']) }}" class="btn  btn-warning">
                              <span class="glyphicon glyphicon-heart">Sukai</span> </a>
                        </td>
